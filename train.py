...
def train(train_loader, model, optimizer, epoch, opt, loss_func, total_step, test_loader):
    model.train()
    ...
    test(test_loader, model, epoch, opt.save_model)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batchsize', type=int, default=6, help='training batch size (Note: ~500MB per img in GPU)')
    ...
    parser.add_argument('--gpu', type=int, default=1, help='choose which gpu you use')
    ...
    parser.add_argument('--train_img_dir', type=str, default='/mnt/datasets/PSD/TrainDataset/images/')
    parser.add_argument('--train_gt_dir', type=str, default='/mnt/datasets/PSD/TrainDataset/masks/')
    parser.add_argument('--train_eg_dir', type=str, default='/mnt/datasets/PSD/TrainDataset/edges/')

    parser.add_argument('--test_img_dir', type=str, default='/mnt/datasets/PSD/TestDataset/CVC-300/images/')
    parser.add_argument('--test_gt_dir', type=str, default='/mnt/datasets/PSD/TestDataset/CVC-300/masks/')
    parser.add_argument('--test_eg_dir', type=str, default='/mnt/datasets/PSD/TestDataset/CVC-300/edge/')
    ...
    for epoch_iter in range(1, opt.epoch):
        ...
        train(train_loader, model, optimizer, epoch_iter, opt, LogitsBCE, total_step, test_loader)
